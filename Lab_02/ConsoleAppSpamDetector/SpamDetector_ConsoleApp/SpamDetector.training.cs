...
namespace SpamDetector_ConsoleApp
{
    public partial class SpamDetector
    {
        public const string RetrainFilePath =  @"C:\Lab_for_Data_Analysis\Lab_02\ConsoleAppSpamDetector\ConsoleAppSpamDetector\email_dataset.csv";
